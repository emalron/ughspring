...
<div class="row-md-10 my-1">
    <h2>글 수정</h2>
    <hr>
    <form method="post" action="${contextPath }/board/edit/${article.articleNo}" encType="UTF-8">
    <div class="row-md-10 my-1">
        <input class="col" type="text" name="title" value="${article.title}" placeholder="제목을 입력하세요" />
        <div class="my-1">
